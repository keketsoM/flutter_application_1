  ...
  void _submit () async{
    ...
    try{
     ...
     ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("If the email was found the reset password link, Check your email"),
        ),);
            ...
            children: [
             ...
             SizedBox(
              ...
              child: ElevatedButton(style:ElevatedButton.styleFrom(backgroundColor: Colors.blue),
                onPressed: _submit, child: const Text("Reset password",style: TextStyle(color: Colors.white),)),
             )
            ],
          ),
        ),
